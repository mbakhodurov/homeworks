...
import (
	...
	"github.com/mbakhodurov/homeworks/week7/order/internal/repository/converter"
	repoModel "github.com/mbakhodurov/homeworks/week7/order/internal/repository/model"
)

func (r *repository) GetOrderByUUID(ctx context.Context, order_uuid string) (model.Order, error) {
