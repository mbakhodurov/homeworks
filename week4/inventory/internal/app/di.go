...
import (
	...
	v1 "github.com/mbakhodurov/homeworks/week4/inventory/internal/api/inventory/v1"
	"github.com/mbakhodurov/homeworks/week4/inventory/internal/config"
	"github.com/mbakhodurov/homeworks/week4/inventory/internal/repository"
	inventoryRepo "github.com/mbakhodurov/homeworks/week4/inventory/internal/repository/inventory"
	"github.com/mbakhodurov/homeworks/week4/inventory/internal/service"
	inventoryService "github.com/mbakhodurov/homeworks/week4/inventory/internal/service/inventory"
...
func (di *diContainer) InventoryV1Api(ctx context.Context) inventory_v1.InventoryServiceServer {
	if di.inventoryApi == nil {
		di.inventoryApi = v1.NewInventoryApi(di.InventoryService(ctx))
	}
