...
import (
	...
	"github.com/mbakhodurov/homeworks/week6/inventory/internal/interceptor"
...
func (a *App) initGrpcServer(ctx context.Context) error {
	...
	inventory_v1.RegisterInventoryServiceServer(a.grpcServer, a.diContainer.InventoryApi(ctx))
