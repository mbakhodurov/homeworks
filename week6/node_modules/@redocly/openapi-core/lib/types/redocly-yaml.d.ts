...
declare const builtInArazzo1Rules: readonly ["sourceDescription-type", "workflowId-unique", "stepId-unique", "sourceDescription-name-unique", "sourceDescriptions-not-empty", "workflow-dependsOn", "outputs-defined", "parameters-unique", "step-onSuccess-unique", "step-onFailure-unique", "respect-supported-versions", "requestBody-replacements-unique", "no-criteria-xpath", "criteria-unique", "no-x-security-scheme-name-without-openapi", "x-security-scheme-required-values", "no-x-security-both-scheme-and-scheme-name", "no-required-schema-properties-undefined", "no-enum-type-mismatch", "no-mixed-number-range-constraints", "no-schema-type-mismatch", "x-security-scheme-name-reference"];
