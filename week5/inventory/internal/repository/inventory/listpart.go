...
import (
	...
	"github.com/mbakhodurov/homeworks/week5/inventory/internal/repository/converter"
	repoModel "github.com/mbakhodurov/homeworks/week5/inventory/internal/repository/model"
	"go.mongodb.org/mongo-driver/bson"
	"go.mongodb.org/mongo-driver/mongo"
)

func (r *repository) ListParts(ctx context.Context, filter model.InventoryFilter) ([]model.Inventory, error) {
	...
	for i, repoInventory := range repoInventories {
		Inventory[i] = converter.InventoryRepoModelToModel(repoInventory)
	}
