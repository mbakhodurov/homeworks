...
import (
	...
	orderDecoderInterface "github.com/mbakhodurov/homeworks/week5/order/internal/converter/kafka"
...
func (s *service) RunConsumer(ctx context.Context) error {
	...
	if err := s.orderComsumer.Consume(ctx, s.OrderHandler); err != nil {
