...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x06filter\x18\x01 \x01(\v2\x19.inventory.v1.PartsFilterR\x06filter\"\xba\x01\n" +
	...
	"\tinventory\x18\x01 \x01(\v2\x17.inventory.v1.InventoryR\tinventory\"\x18\n" +
	...
	"\rdeleted_count\x18\x01 \x01(\x03R\fdeletedCount\"p\n" +
	...
	"dimensions\x12>\n" +
	"\fmanufacturer\x18\a \x01(\v2\x1a.inventory.v1.ManufacturerR\fmanufacturer\"\x94\x02\n" +
	"\tInventory\x12\x12\n" +
	"\x04uuid\x18\x01 \x01(\tR\x04uuid\x12B\n" +
	...
	"\x0fDeleteInventory\x12$.inventory.v1.DeleteInventoryRequest\x1a\x1c.inventory.v1.DeleteResponse\" \x82\xd3\xe4\x93\x02\x1a*\x18/api/v1/inventory/{uuid}BSZQgithub.com/mbakhodurov/homeworks/week5/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*CreateInventoryRequest)(nil),    // 4: inventory.v1.CreateInventoryRequest
	(*CreateInventoryResponse)(nil),   // 5: inventory.v1.CreateInventoryResponse
	(*GetInventoryByUUIDRequest)(nil), // 6: inventory.v1.GetInventoryByUUIDRequest
	(*GetInventoryResponse)(nil),      // 7: inventory.v1.GetInventoryResponse
	...
	(*DeleteInventoryRequest)(nil),    // 10: inventory.v1.DeleteInventoryRequest
	(*DeleteResponse)(nil),            // 11: inventory.v1.DeleteResponse
	(*UpdateInventoryRequest)(nil),    // 12: inventory.v1.UpdateInventoryRequest
	(*InventoryUpdateInfo)(nil),       // 13: inventory.v1.InventoryUpdateInfo
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	15, // 3: inventory.v1.CreateInventoryRequest.info:type_name -> inventory.v1.InventoryInfo
	14, // 4: inventory.v1.GetInventoryResponse.inventory:type_name -> inventory.v1.Inventory
	14, // 5: inventory.v1.GetAllInventoryResponse.inventory:type_name -> inventory.v1.Inventory
	13, // 6: inventory.v1.UpdateInventoryRequest.update_info:type_name -> inventory.v1.InventoryUpdateInfo
	20, // 7: inventory.v1.InventoryUpdateInfo.name:type_name -> google.protobuf.StringValue
	20, // 8: inventory.v1.InventoryUpdateInfo.description:type_name -> google.protobuf.StringValue
	21, // 9: inventory.v1.InventoryUpdateInfo.price:type_name -> google.protobuf.DoubleValue
	22, // 10: inventory.v1.InventoryUpdateInfo.stock_quantity:type_name -> google.protobuf.Int64Value
	0,  // 11: inventory.v1.InventoryUpdateInfo.category:type_name -> inventory.v1.Category
	16, // 12: inventory.v1.InventoryUpdateInfo.dimensions:type_name -> inventory.v1.Dimensions
	17, // 13: inventory.v1.InventoryUpdateInfo.manufacturer:type_name -> inventory.v1.Manufacturer
	...
	4,  // 24: inventory.v1.InventoryService.CreateInventory:input_type -> inventory.v1.CreateInventoryRequest
	6,  // 25: inventory.v1.InventoryService.GetInventoryByUUID:input_type -> inventory.v1.GetInventoryByUUIDRequest
	8,  // 26: inventory.v1.InventoryService.GetAllInventory:input_type -> inventory.v1.GetAllInventoryRequest
	12, // 27: inventory.v1.InventoryService.UpdateInventory:input_type -> inventory.v1.UpdateInventoryRequest
	10, // 28: inventory.v1.InventoryService.DeleteInventory:input_type -> inventory.v1.DeleteInventoryRequest
	3,  // 29: inventory.v1.InventoryService.ListPartInventory:output_type -> inventory.v1.ListPartInventoryResponse
	5,  // 30: inventory.v1.InventoryService.CreateInventory:output_type -> inventory.v1.CreateInventoryResponse
	7,  // 31: inventory.v1.InventoryService.GetInventoryByUUID:output_type -> inventory.v1.GetInventoryResponse
	...
	11, // 34: inventory.v1.InventoryService.DeleteInventory:output_type -> inventory.v1.DeleteResponse
